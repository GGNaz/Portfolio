    ...
    <div className="bg-gray-600 p-5">
      ...
      <div >
          <div class="pt-8 text-center">
              <h1 class="text-4xl font-bold text-white inline-flex items-center mb-1">
               <span>My Skills</span>
              </h1>
      ...
      <div className="container xl:max-w-7xl mx-auto px-4 py-5 ">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          <a onClick={() => openProjects("React Js", )} className="cursor-pointer sm:col-span-2 md:col-span-1 block group relative transition ease-out active:opacity-75 overflow-hidden" >
          ...
          <a  className="cursor-pointer modal-button sm:col-span-2 md:col-span-1 block group relative transition ease-out active:opacity-75 overflow-hidden" htmlFor="my-modal-5">
    ...
    </div>
      {
        ...
        >
           <div class="pt-8 text-center">
            ...
            <div classNameName="modal-box w-11/12 max-w-5xl">
